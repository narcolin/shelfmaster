      ...
      <div className="row">
        <div className="column2">
          <p>
            ...
            their meals and make sure they have enough food to last. ShelfMaster
            is an inventory site that allows users to easily add or remove items
            from their tally. This product creatively formats your pantry items
            into food group categories, like grains, proteins, vegetables, etc.
            <br />
            <br />
